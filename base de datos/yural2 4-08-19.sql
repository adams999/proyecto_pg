...
3	1	t	f	t	f	t	t	t	t	1	f	t	t	t
4	3	t	t	t	t	t	t	t	t	1	t	t	t	f
\.
...
SELECT pg_catalog.setval('logs_id_log_seq', 697, true);
...
SELECT pg_catalog.setval('pre_logs_id_pre_log_seq', 279, true);
...
SELECT pg_catalog.setval('session_id_session_seq', 120, true);

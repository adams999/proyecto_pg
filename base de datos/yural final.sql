...
SELECT pg_catalog.setval('logs_id_log_seq', 541, true);
...
SELECT pg_catalog.setval('pre_logs_id_pre_log_seq', 198, true);
...
SELECT pg_catalog.setval('session_id_session_seq', 104, true);

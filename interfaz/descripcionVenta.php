...
<body>
    ...
    <article class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
            <p class="titulo1">
                <a name="ir"></a>
                <i class="glyphicon glyphicon-shopping-cart"></i> Detalle Venta ID: <?php echo "$id"; ?> 
            </p>
            <p>
        ...
        $sql="SELECT * FROM ventas_productos WHERE id_venta_producto='$id' and estatus=2";
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" align="center"><br><br>
    <a href="listaProductosVendidos.php#ir">
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" align="center"><br><br>
    <?php echo  '<a onclick="javascript:preguntar(id='.$id.')">'?>
        <button class="btn btn-info">
            <i class="glyphicon glyphicon-paperclip"> </i> Venta en Revisión
        </button>
    </a>
</div>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" align="center"><br><br>
    <?php echo  '<a onclick="javascript:preguntar2(id='.$id.')">'?>
        <button class="btn btn-success">
            <i class="glyphicon glyphicon-ok"> </i> Venta Concretada
        </button>
    </a>
</div>

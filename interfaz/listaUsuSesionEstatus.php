...
<body>
    ...
    <article class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
            ...
            <p class="titulo1">
            <a name="ir"></a>
            Administrar Usuarios <i class="glyphicon glyphicon-user"></i></p>
        </div>
       ...
       if(isset($_GET['ini'])){
        $ini=$_GET['ini'];
        $fin=$_GET['fin'];
        $sql="SELECT * FROM usuario where estatus=1 ORDER BY id_usuario desc limit 10 offset $ini";
    }else{
        $sql="SELECT * FROM usuario where estatus=1 ORDER BY id_usuario desc limit 10 offset 0";
    }
    ...
    <table class="table table-bordered" align="center">
        <tr class=" btn-primary trTitulo" align="center">
            ...
            <td class="titulo" width="5%">Des- activar</td>
        </tr>
    </table>
</div>';
...
//aqui muestro el tr con los apartados correspondientes del usuario logueado
    ...
    for($c=1;$c<=$pag;$c++){
        $ini=$c*10-10;
        $fin=$ini+9;
        echo ' <a href="listaUsuSesionEstatus.php?ini='.$ini.'&fin='.$fin.'#ir">'.$c.'</a>&nbsp;&nbsp;';
    }
    echo '</div>';
    ?>           

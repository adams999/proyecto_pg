	...
	<head>
	    <meta charset="utf-8">
	    <title>Registrar Banco Empresa</title>
	...
	<article class="row">
	        ...
	        <div class="row">
	            ...
	            <form class="form form-group" action="Registros_sql/registroBancoEmpresa.php" method="post">
	                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 form-group has-success" align="center">
	                 ...
	                 <p>
	                     <select class="form-control" type="text" placeholder="Selecciona el Tipo de Cuenta" required="required" name="tipo_cuen_empr" minlength="6" maxlength="9" pattern="[A-Za-z]+">
	                     	<option></option>
	             ...
	             <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 form-group has-success" align="center">
	                ...
	                <p>
	                 <input class="form-control" type="text" placeholder="Ingresa el Nombre del Titular" required="required" name="titu_cuen_empr" minlength="10" maxlength="100" pattern="[a-zA-Z ]+"><br><br>
	             </p>
	            ...
	            <p>
		            ...
		            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-8">
		             	<input class="form-control" type="text" placeholder="(Ejem.24819181)" required="required" name="cedu_cuen_empr" minlength="6" maxlength="10" pattern="[0-9]+" id="numCeduRif" onKeyUp="rifCedulaBanco()" onclick="rifCedulaBanco()"><br>
		         	</div>
	         </p>
	     </p>
	    ...
	    <p class="campRegis">
	                 ...
	                 <p>
	                     <div class="col-lg-3 col-md-2 col-sm-2 col-xs-6">
	                 		<input class="form-control" type="text" placeholder="Ingresa Número de Cuenta de Empresa"  name="pref_cuenta" required="required" minlength="4" maxlength="4" pattern="[0-9]+" onKeyUp="validaBanco()" id="cuenta">
	                 	</div>
	                 	<div class="col-lg-9 col-md-10 col-sm-10 col-xs-6">
	                     	<input class="form-control" type="text" placeholder="Ingresa Número de Cuenta de Empresa"  name="num_cuen_empr" required="required" minlength="16" maxlength="16" pattern="[0-9]+"><br>
	                 	</div>
	                 </p>

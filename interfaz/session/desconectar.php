...
if($_SESSION['id_usuarioA']){	//proceso para que un usuario Comun se desconecte de su session
...
pg_query($conexion,$insertar);
	...
	echo '<article class="container-fluid">
            ...
            <br><br><br><br><br>
                <p class="titulo1">
                    <i class="glyphicon glyphicon-ok" style="color: green"></i>&nbsp;&nbsp;&nbsp;'.$nombreUsuario.' Sesión Terminada
                </p><br>                    
            </div>

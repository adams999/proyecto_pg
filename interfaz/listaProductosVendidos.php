...
$acumuladorVC = 0;
@$sql1 = ("SELECT * FROM ventas_productos where estatus=10");
...
while (@$arreglo1 = pg_fetch_array($query1)) { //este arreglo ordena la informacion del array correspondiente a los apartados para despues llamar la informacion que se necesite
    ...
    $cantidadPaga = ($cantidadPaga - 9);
    $acumuladorVC += $cantidadPaga;
}
...
<body>
    <section class="container-fluid">
        ...
        <article class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
                <p class="titulo1">
                    <a name="ir"></a>
                    Ventas <i class="glyphicon glyphicon-shopping-cart"></i></p>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" align="left">
                <a href="ventasEnRevisionAdmin.php#ir">
                    <button class="btn btn-info">
                        Ventas en Revisión <i class="glyphicon glyphicon-paperclip"></i>
                    </button>
                </a>
            </div>

            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" align="right">
                <a href="ventasConcretasAdmin.php#ir">
                    <button class="btn btn-success">
                        <?php
                        if (@$acumuladorVC > 0) {
                            echo '&nbsp;<span class="badge badge-warning" style="color:blue; background:#EAECEE;">' . @$acumuladorVC . '</span>';
                        } ?>
                        Ventas Concretadas <i class="glyphicon glyphicon-piggy-bank"></i>
                    </button>
                </a>
            </div>
            ...
            $sql = "SELECT * FROM ventas_productos WHERE estatus=2 ORDER BY id_venta_producto DESC";
        ...
        $num Venta. En $pag Páginas. ";
            ...
            if (isset($_GET['ini'])) {
                $ini = $_GET['ini'];
                $fin = $_GET['fin'];
                $sql = "SELECT * FROM ventas_productos WHERE estatus=2 ORDER BY id_venta_producto DESC LIMIT 10 offset $ini";
            } else {
                $sql = "SELECT * FROM ventas_productos WHERE estatus=2 ORDER BY id_venta_producto DESC LIMIT 10 offset 0";
            }
    ...
    <table class="table table-bordered" align="center">
                ...
                while ($arreglo2 = pg_fetch_array($query2)) {
                    ...
                    while ($arreglo3 = pg_fetch_array($query3)) {
                        ...
                        while ($arreglo4 = pg_fetch_array($query4)) {
                            ...
                            $sql5 = "SELECT 	id_detalle_apartado,
                            id_usuario,
                            id_producto_venta,
                            cantidad_apartada,
                            fecha_hora,
                            ...
                            precio_unidad,
                            to_char(
                                DATE (fecha_hora) + '3 days' :: INTERVAL,
                                'DD/MM/YYYY'
                            ) AS fecha3dias FROM detalle_apartado where id_apartado='$id_apartado'";
                            ...
                            while ($arreglo5 = pg_fetch_array($query5)) {
                                ...
                                echo '   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">';
                                if (strtotime($arreglo5['fecha3dias']) == strtotime(date('d/m/Y'))) {
                    ...
                    <tr class="parrafo " align="center">
                        ...
                        <td class="titulo" width="5%"><br>
                            <a href="descripcionVenta.php?id=' . $id_venta_producto . '&apar=' . $id_apartado . '#ir">    
                                <i class="glyphicon glyphicon-eye-open" style="color:orange;" title="Ver Detalles"></i>
                            </a><br><hr>
                            <a onclick="javascript:preguntar(id=' . $id_venta_producto . ')">    
                                <i class="glyphicon glyphicon-paperclip" style="color:grey;" title="Calificar como Pendiente/Revisión"></i>
                            </a><hr>
                            <a onclick="javascript:preguntar3(id=' . $id_venta_producto . ')">   
                                <i class="glyphicon glyphicon-piggy-bank" style="color:green;" title="Calificar venta como Concretada "></i>
                            </a>
        ...
        <b>
            ...
            Total de Unidad Vendidas:";
            echo @$acum_cant_apart;
            echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hasta la Fecha " . $fecha_actual . "<br><br>
        </b>
    </div>";
            ...
            for ($c = 1; $c <= $pag; $c++) {
                $ini = $c * 10 - 10;
                $fin = $ini + 9;
                echo ' <a href="listaProductosVendidos.php?ini=' . $ini . '&fin=' . $fin . '#ir">' . $c . '</a>&nbsp;&nbsp;';
            }
            echo '</div>';

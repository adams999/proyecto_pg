...
<head>
    <meta charset="utf-8">
    <title>Detalle Venta Concretada</title>
...
<body>
    ...
    <article class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
            <p class="titulo1">
                <a name="ir"></a>
                <i class="glyphicon glyphicon-shopping-cart"></i> Detalle Venta Concretada ID: <?php echo "$id"; ?> 
            </p>
            <p>
        ...
        $sql="SELECT * FROM ventas_productos WHERE id_venta_producto='$id' and estatus=10";
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" align="center"><br><br>
    <?php echo  '<a href="reporteVentas.php?id='.$id.'&apar='.$apar.'">'?>
        <button class="btn btn-success">
            <i class="glyphicon glyphicon-save"> </i> Descargar Reporte de Venta
        </button>
    </a>
</div>

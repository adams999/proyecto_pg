      ...
      <form class="form form-group" method="post" action="Registros_sql/registroUsuario.php">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 form-group has-success" align="center">
            ...
            <p>
              <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                <input class="form-control" type="text" placeholder="V-/E-/J-" required="required" name="prefijoCedula" minlength="2" maxlength="2" pattern="[VEJ-]+" id="ceduRif" onKeyUp="rifCedulaBanco()" onclick="rifCedulaBanco()">
              </div>
            ...
            <p class="campRegis">
              <label>
                Pregunta de Seguridad &nbsp; <a href="#"><i class="glyphicon glyphicon-exclamation-sign pull-right" title="Ingresa direccion de tu Hogar para poder realizar envios de productos a tu vivienda."></i></a>
              </label>
            </p>
          ...
          <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 form-group has-success" align="center">
            ...
            <p class="campRegis">
              <label>
              Respuesta de Seguridad &nbsp; <a href="#"><i class="glyphicon glyphicon-exclamation-sign pull-right" title="Ingresa la respuesta de seguridad para que puedas recuperar tu contraseña"></i></a>
              </label>
            </p>

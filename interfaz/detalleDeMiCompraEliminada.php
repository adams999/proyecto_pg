...
<head>
    <meta charset="utf-8">
    <title>Detalle Compra Rechazada</title>
    ...
    <article class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
            <p class="titulo1" style="color: #C70039">
                <a name="ir"></a>
                <i class="glyphicon glyphicon-remove-circle"></i> Detalle Compra Rechazada ID: <?php echo "$id"; ?> 
            </p>
            <p>
...
while(@$aaa=pg_fetch_array($ww)){//este aaa ordena la informacion del array correspondiente a los apartados para despues llamar la informacion que se necesite
    ...
    $telefono_empresa=$aaa['telefono_empresa'];
        ...
        $sql="SELECT * FROM ventas_productos WHERE id_venta_producto='$id' and estatus=0 and id_usuario='{$_SESSION['id_usuario']}'";
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
    <br><br><br><h2 style="color: #C70039">Detalle Compra Rechazada</h2>
</div>
...
$acumuladorAfuera=0;
$acumuladorAfuera1=0;
                                $sql5=("SELECT * FROM detalle_apartado where id_apartado='$id_apartado' and id_usuario='{$_SESSION['id_usuario']}' and estatus=0");
...
if (@$acumuladorAfuera1==true) {
    ...
    <p>
        <font color='#2C6499' style='font-size:180%;'><hr>
            <b> Cantidad de Articulos: $acumCant &nbsp;&nbsp;&nbsp; Bs. $acumuladorAfuera1 <b>
        </font>
    <p>

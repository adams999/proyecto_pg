...
<head>
    <meta charset="utf-8">
    <title>Ventas En Revision</title>
...
<body>
    ...
    <article class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
            <p class="titulo1">
            <a name="ir"></a>
            Ventas En Revision <i class="glyphicon glyphicon-paperclip"></i></p>
        </div>
        ...
        $sql="SELECT * FROM ventas_productos WHERE estatus=3 ORDER BY id_venta_producto DESC";
        ...
        $num Ventas en Revisiòn. En $pag Páginas. ";
     ...
     if(isset($_GET['ini'])){
        $ini=$_GET['ini'];
        $fin=$_GET['fin'];
        $sql="SELECT * FROM ventas_productos WHERE estatus=3 ORDER BY id_venta_producto DESC LIMIT 10 offset $ini";
    }else{
        $sql="SELECT * FROM ventas_productos WHERE estatus=3 ORDER BY id_venta_producto DESC LIMIT 10 offset 0";
    }
...
if ($num==0 or $num==null) {
    echo "<div align='center' style='color:red; font-size:20px;'>No Hay Ventas En Revisión.<br><br><br></div>";
}
                ...
                <table class="table table-bordered table-hover table-striped" align="center">
                    ...
                    <tr class="parrafo " align="center">
                        ...
                        <td class="titulo" width="5%"><br>
                            <a href="descripcionVentaRevision.php?id='.$id_venta_producto.'&apar='.$id_apartado.'#ir">    
                                <i class="glyphicon glyphicon-eye-open" style="color:orange;" title="Ver Detalles"></i>
                            </a><br><hr>
                            <a onclick="javascript:preguntar2(id='.$id_venta_producto.')">    
                                <i class="glyphicon glyphicon-remove-circle" style="color:red;" title="Eliminar Venta"></i>
                            </a><br><hr>
...
date_default_timezone_set('America/Caracas');
        ...
        <b>
             Bs Totales: $acumulador &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Total de Unidades:"; echo @$acum_cant_apart; echo"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hasta la Fecha ".$fecha_actual."<br><br>
        </b>
    </div>";
...
for($c=1;$c<=$pag;$c++){
    $ini=$c*10-10;
    $fin=$ini+9;
    echo ' <a href="ventasEnRevisionAdmin.php?ini='.$ini.'&fin='.$fin.'#ir">'.$c.'</a>&nbsp;&nbsp;';
}
echo '</div>';
...
<script language="Javascript">
    function preguntar2(id){
       eliminar=confirm("ADMINISTRADOR  -<?php echo "$nombreAdmin"; ?>- ¿Realmente Deseas Cancelar la Venta con el ID:-<?php echo "$id_venta_producto"; ?>- del Usuario Selecionado?");
       if (eliminar)

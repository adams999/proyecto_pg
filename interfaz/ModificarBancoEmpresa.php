	...
	<head>
	    <meta charset="utf-8">
	    <title>Modificar Banco Empresa</title>
	...
	<article class="row">
	    ...
	    $sql="SELECT * FROM bancos_empresa WHERE id_banco_empresa = '$id'";
	    ...
	    $ressql=pg_query($conexion,$sql);
	        while ($row=pg_fetch_array ($ressql)){//aqui cargo las variables correspondientes al array del banco empresa
	            $nomb_banc_empr=$row['nomb_banc_empr'];
	            $tipo_cuen_empr=$row['tipo_cuen_empr'];
	            $num_cuen_empr=$row['num_cuen_empr'];
	            $titu_cuen_empr=$row['titu_cuen_empr'];
	            $cedu_cuen_empr=$row['cedu_cuen_empr'];
	        }
	        ...
	        <div class="row">
	            ...
	            <form class="form form-group" <?php echo 'action="modificar/modificarBancoEmpresa.php?id='.$id.'"' ?> method="post">
	                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 form-group has-success" align="center">
	                 ...
	                 <p>
	                     <select class="form-control" type="text" placeholder="Selecciona un Banco para Proceder con el Registro" required="required" name="nomb_banc_empr" minlength="6" maxlength="100" pattern="[A-Za-z]+" autofocus onKeyUp="validaBanco()" id="banco" onclick="validaBanco()">
	                 ...
	                 <p>
	                     <select class="form-control" type="text" placeholder="Selecciona elTipo de Cuenta" required="required" name="tipo_cuen_empr" minlength="6" maxlength="9" pattern="[A-Za-z]+">
	                     	<?php 
	                     		if (@$tipo_cuen_empr) {
	                     			echo '<option>'.$tipo_cuen_empr.'</option>';
	                     		}
	                     	 ?>
	             ...
	             <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 form-group has-success" align="center">
	                ...
	                <p>
	                 <input class="form-control" type="text" placeholder="Modifica el Nombre del Titular" required="required" name="titu_cuen_empr" value="<?php echo $titu_cuen_empr; ?>" minlength="10" maxlength="100" pattern="[a-zA-Z ]+"><br><br>
	             </p>
	            ...
	            <p>
	            	<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
	            		<input class="form-control" type="text" placeholder="V-/E-/J-" required="required" name="ceduRif" minlength="2" maxlength="2" pattern="[VEJ-]+" id="ceduRif" onKeyUp="rifCedulaBanco()" onclick="rifCedulaBanco()" value="<?php echo substr($cedu_cuen_empr,0,2) ?>">
	            	</div>

		            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-8">
		             	<input class="form-control" type="text" placeholder="(Ejem.24819181)" required="required" name="cedu_cuen_empr" value="<?php echo substr($cedu_cuen_empr, 2); ?>" minlength="6" maxlength="10" pattern="[0-9]+" id="numCeduRif" onKeyUp="rifCedulaBanco()" onclick="rifCedulaBanco()"><br>
		         	</div>
	         </p>
	     </p>
	    ...
	    <p class="campRegis">
	                 ...
	                 <p>
	                     <div class="col-lg-3 col-md-2 col-sm-2 col-xs-6">
	                 		<input class="form-control" type="text" placeholder="Ingresa Número de Cuenta de Empresa"  name="pref_cuenta" required="required" minlength="4" maxlength="4" pattern="[0-9]+" onKeyUp="validaBanco()" id="cuenta" onclick="validaBanco()" value="<?php echo substr($num_cuen_empr,0,4) ?>">
	                 	</div>
	                 	<div class="col-lg-9 col-md-10 col-sm-10 col-xs-6">
	                     	<input class="form-control" type="text" placeholder="Ingresa Número de Cuenta de Empresa"  name="num_cuen_empr" required="required" value="<?php echo substr($num_cuen_empr, 4); ?>" minlength="16" maxlength="16" pattern="[0-9]+"><br>
	                 	</div>
	                 </p>
	...
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 form-group has-success" align="center">
	 <a href="#">
	   <button class="reg1 btn btn-group" type="submit" value="Registrar" name="Registrar" onclick="rifCedulaBanco()" onclick="validaBanco()" onkeyup="validaBanco()" onkeyup="rifCedulaBanco()">
	...
	<script language="Javascript">
	    function preguntar(id){
	     eliminar=confirm("¿Deseas Eliminar El Banco Con el ID: <?php echo "$id"; ?> Perteneciente a: <?php echo "$nomb_banc_empr"; ?> ?");
	     if (eliminar)
	           //Redireccionamos si das a aceptar
	             window.location.href = "modificar/eliminarBancoEmpresa.php?id="+id; //página web a la que te redirecciona si confirmas la eliminación
	             else

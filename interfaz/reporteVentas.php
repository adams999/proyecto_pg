...
<head>
    <meta charset="utf-8">
    <title>Reporte Venta <?php echo $id; ?></title>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <p style="font-size: 8pt; line-height: 5px" align="right">
            <b>Reporte Emitìdo El:</b> <?php echo $FechaHoraReporte; ?> <b>Por:</b> <?php echo "{$_SESSION['nombre']}"; ?>
    </p>
    ...
    <table class="table table-bordered tableReporte" align="center">
        ...
        <p style="font-size: 7pt; line-height: 5px" align="right">
            <b>Fecha Hora Apartado:</b> <?php echo $fecha_hora_apartado; ?>
        </p>
...
if (@$acumuladorAfuera1==true) {
    ...
    <p>
        <font color='#2C6499' style='font-size:80%;'><hr>
            <b> Cantidad de Articulos Vendidos: $acumCant &nbsp;&nbsp;&nbsp;Venta Total: Bs. $acumuladorAfuera1 <b>
        </font>
    <p>
...
<?php
    ...
    $dompdf->render();
    $pdf=$dompdf->output();
    $filename="ReporteVentaConcreta_ID:".$id; 

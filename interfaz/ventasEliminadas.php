...
<body>
    ...
    <article class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
            ...
            <a name="ir"></a>
            Ventas Eliminadas <i class="glyphicon glyphicon-folder-close"></i></p>
        </div>
        ...
        $sql="SELECT * FROM ventas_productos WHERE estatus=0 ORDER BY id_venta_producto DESC";
        ...
        $num Ventas en Eliminadas. En $pag Páginas. ";
     ...
     if(isset($_GET['ini'])){
        $ini=$_GET['ini'];
        $fin=$_GET['fin'];
        $sql="SELECT * FROM ventas_productos WHERE estatus=0 ORDER BY id_venta_producto DESC LIMIT 10 offset $ini";
    }else{
        $sql="SELECT * FROM ventas_productos WHERE estatus=0 ORDER BY id_venta_producto DESC LIMIT 10 offset 0";
    }
    ...
    <table class="table table-bordered" align="center">
        <tr class=" btn-primary trTitulo" align="center">
            ...
            <td class="titulo" width="8%">Fecha Hora<br>Apartado</td>
...
if ($num==0 or $num==null) {
    echo "<div align='center' style='color:red; font-size:20px;'>No Hay Ventas Eliminadas.<br><br><br></div>";
}
                ...
                <table class="table table-bordered table-hover table-striped" align="center">
                    ...
                    <tr class="parrafo " align="center">
                        ...
                        <td class="titulo" width="5%"><br><br><br>
                            <a href="descripcionVentaEliminada.php?id='.$id_venta_producto.'&apar='.$id_apartado.'#ir">    
...
for($c=1;$c<=$pag;$c++){
    $ini=$c*10-10;
    $fin=$ini+9;
    echo ' <a href="ventasEliminadas.php?ini='.$ini.'&fin='.$fin.'#ir">'.$c.'</a>&nbsp;&nbsp;';
}
echo '</div>';

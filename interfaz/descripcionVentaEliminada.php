...
<head>
    <meta charset="utf-8">
    <title>Detalle Venta Eliminada</title>
    ...
    <article class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
            <p class="titulo1" style="color: #C70039">
                <a name="ir"></a>
                <i class="glyphicon glyphicon-shopping-cart"></i> Detalle Venta Eliminada ID: <?php echo "$id"; ?> 
            </p>
            <p>
        ...
        $sql="SELECT * FROM ventas_productos WHERE id_venta_producto='$id' and estatus=0";
...
if (@$acumuladorAfuera1==true) {
    ...
    <p>
        <font color='#2C6499' style='font-size:180%;'><hr>
            <b> Cantidad de Articulos: $acumCant &nbsp;&nbsp;&nbsp;Precio: Bs. $acumuladorAfuera1 <b>
        </font>
    <p>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
    <a href="ventasEliminadas.php#ir">
        <button class="btn btn-primary">
            <i class="glyphicon glyphicon-menu-left"></i> Atras
        </button>
    </a>
</div>       

...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
            <p class="titulo1">
            <a name="ir"></a>
            Mis Compras <i class="glyphicon glyphicon-piggy-bank "></i></p>
        </div>

        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="left">
            <a href="misComprasEliminadas.php#ir">
                <button class="btn btn-danger">
                    Compras Rechazadas <i class="glyphicon glyphicon-remove-circle"></i>
                </button>
            </a>
        </div>
        ...
        require("conexionBD/conexionBD.php");
        $sql="SELECT * FROM ventas_productos WHERE estatus>=2 and id_usuario='{$_SESSION['id_usuario']}' ORDER BY id_venta_producto DESC";
        ...
        $num Compras. En $pag Páginas. ";

        if (isset($prodIni) and isset($prodFin)) {
         echo "&nbsp;&nbsp;&nbsp;Compras: $prodIni - $prodFin";
     }
     echo "<br></div>";
     ...
     if(isset($_GET['ini'])){
        $ini=$_GET['ini'];
        $fin=$_GET['fin'];
        $sql="SELECT * FROM ventas_productos WHERE estatus>=2 and id_usuario='{$_SESSION['id_usuario']}' ORDER BY id_venta_producto DESC LIMIT 10 offset $ini";
    }else{
        $sql="SELECT * FROM ventas_productos WHERE estatus>=2 and id_usuario='{$_SESSION['id_usuario']}' ORDER BY id_venta_producto DESC LIMIT 10 offset 0";
    }
    ...
    <table class="table table-bordered" align="center">
        <tr class=" btn-primary trTitulo" align="center">
            <td class="titulo" width="10%" align="center">N° Compra /<br> Estatus</td>
...
//aqui muestro el tr con los apartados correspondientes del usuario logueado
                ...
                <tr class="table-info parrafo" align="center">
                    ...
                    <b>'.$id_venta_producto.'</b>';
                        ...
                        if (@$estatus_venta==10) {
                            echo '<br><br><br><i class="glyphicon glyphicon-ok" style="color:green;"></i>';
                        }

                        if (@$estatus_venta==3) {
                            echo '<br><br><br><i class="glyphicon glyphicon-paperclip" style="color:grey;"></i>';
                        }

                        if (@$estatus_venta==2) {
                            echo '<br><br><br><i class="glyphicon glyphicon-eye-open" style="color:orange;"></i>';
                        }
                        ...
                        <td class="titulo table-info" width="5%"><br>
                            <a href="detalleDeMiCompra.php?id='.$id_venta_producto.'&apar='.$id_apartado.'#ir">    
                                <i class="glyphicon glyphicon-eye-open" style="color:orange;" title="Ver Detalles"></i>
                            </a><br><hr>';



$sql9="SELECT * FROM opiniones WHERE id_venta_producto='$id_venta_producto' and id_usuario='{$_SESSION['id_usuario']}'";
//la variable  $conexion viene de connect_db que lo traigo con el require("connect_db.php");

    $ressql9=pg_query($conexion,$sql9);
    $result1=pg_num_rows($ressql9);




if (!$result1>=1 and $estatus_venta==10) {
    echo'<a href="detalleDeMiCompra.php?id='.$id_venta_producto.'&apar='.$id_apartado.'#comentar">    
            <i class="glyphicon glyphicon-comment" style="color:green;" title="Comentar Sobre la Compra"></i>
        </a><hr>';
                    ...
                    if (@$estatus_venta==10) {
                        echo '
                            <a href="reporteCompras.php?id='.$id_venta_producto.'&apar='.$id_apartado.'">    
...
date_default_timezone_set('America/Caracas');
        ...
        <b>
            Cantidad Cancelado BS: $acumulador &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Total de Unidad Compradas: "; echo @$acum_cant_apart; echo"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hasta la Fecha ".$fecha_actual."<br><br>
        </b>
    </div>";
...
for($c=1;$c<=$pag;$c++){
    $ini=$c*10-10;
    $fin=$ini+9;
    echo ' <a href="misProductosCancelados.php?ini='.$ini.'&fin='.$fin.'#ir">'.$c.'</a>&nbsp;&nbsp;';
}
echo '</div>';
...
?>    
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
    <br><br><a href="index1.php#ir">
        <button class="btn btn-primary">
            <i class="glyphicon glyphicon-chevron-left"></i>Salìr
        </button><br><br><br>
    </a>
</div>       
